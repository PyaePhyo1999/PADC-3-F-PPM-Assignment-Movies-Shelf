package com.pyaephyomaung.padcmyanmar.movieshelf.network;
...
import com.pyaephyomaung.padcmyanmar.movieshelf.network.responses.GetMoviesResponse;
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                try {
                    ...
                    String resString = stringBuilder.toString();//9.
                    Log.d(MoviesApp.LOG_TAG, "responseString " + resString);

                    Gson gson = new Gson();
                    GetMoviesResponse getMoviesResponse = gson.fromJson(resString, GetMoviesResponse.class);
                    Log.d(MoviesApp.LOG_TAG, "getMoviesResponse movie size : " + getMoviesResponse.getPopularMovies().size());

                    EventBus.getDefault().post(new LoadedMoviesEvent(getMoviesResponse.getPopularMovies()));

                } catch (Exception e) {
                    Log.d(MoviesApp.LOG_TAG, e.getMessage());
                    /*
